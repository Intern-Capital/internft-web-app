    ...
    <div className="partners shadow-2xl overflow-visible bg-gradient-to-r from-darkviolet to-darkpurple">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2 sm:mb-6 mb-6">
            <a
          ...
          <div className="pl-0 lg:pl-12">
            ...
            <p className="mt-3 max-w-3xl text-lg text-gray-100 mb-8">
              With support from our partners, we are building a community of the
              greatest minds accross a wide range of verticals. Our interns are
              working on projects that are challenging, but rewarding. Join us.
            </p>
            <InternButton
              onClick={() => {
                window.open(
