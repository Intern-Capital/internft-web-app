...
export function Roadmap() {
  ...
  return (
    <div
      id="roadmap"
      className="roadmap overflow-hidden relative py-10 md:py-16 lg:py-48 dark text-white"
    >
      <Background showBackgroundImage={true} />
      <div className="max-w-7xl m-auto lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-start px-6 sm:px-6 lg:px-8">
              ...
              <div className="relative">
                <dt>
                  <div className="absolute justify-center text-center h-12 w-12 inline-flex items-center p-1 uppercase border border-indigo-900 font-medium rounded-full shadow-sm hover:from-purple-800 hover:to-indigo-900 bg-gradient-to-b from-purple-700 to-indigo-800 ">
                    <span
                      className="font-extrabold -pt-1 h-6 w-6 text-lg"
                      aria-hidden="true"
                    >
                      1
                    </span>
                ...
                <dd className="mt-2 ml-16 text-base text-gray-200">
                  InternNFT Launch with 6,942 available for mint and 69.42 UST
                  per NFT
                </dd>
              </div>
            </dl>{' '}
          ...
          <Fade right>
            ...
            <dl className="space-y-10 mb-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-200">
                  Vaults provide intrinsic XP for interns while also providing
                  in-game currency accumulation for future shop feature to
                  accumulate items and rewards
                </dd>
              </div>
            </dl>{' '}
          </Fade>
          <Fade right>
            ...
            <dl className="space-y-10 mb-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-200">
                  Weekly items available to purchase based on progress of the
                  InternNFT
                </dd>
              </div>
            </dl>
          ...
          <Fade right>
            <dl className="space-y-10 mb-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-200">
                  InterNFTs serve as an entry ticket to all new projects on
                  Intern Capital and provide additional utility in the ecosystem
                </dd>
              </div>
            </dl>
          </Fade>
        ...
        <div className="mt-10 pr-5 relative lg:mt-0 lg:col-start-1">
          ...
          <p className="mt-3 text-lg text-gray-200 mb-10 sm:mb-20">
            InterNFTs are an artistic work that have been built for interns by
            interns to put the <i>ser</i> in serve. Intern Capital has designed
            the project with intention that it'll become a symbol within the
            entity itself, and grow in value with the community.
          </p>
          <img
