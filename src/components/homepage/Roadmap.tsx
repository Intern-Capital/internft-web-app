          ...
          <dl className='space-y-10 mb-10'>
            <div className='relative'>
              <dt>
                ...
                <h1 className='ml-16 text-2xl mb-6 pt-3 leading-6 text-purple-200 uppercase'>
          ...
          <dl className='space-y-10 mb-10'>
            <div className='relative'>
              <dt>
                ...
                <h1 className='ml-16 text-2xl mb-6 pt-3 leading-6 text-purple-100 uppercase'>
                  Phase 4 - Evolving of InterNFT
                </h1>
              </dt>
              <dd className='mt-2 ml-16 text-base text-gray-200'>
                InterNFTs serve as an entry ticket to all new projects on Intern Capital and provide
                additional utility in the ecosystem
              </dd>
            </div>
          </dl>
        </div>
