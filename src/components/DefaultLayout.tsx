...
import ConnectedButton from '@/packages/terra/components/ConnectedButton';
  ...
  const navigation = [
    {
      name: 'Dashboard',
      href: '/',
      icon: (props) => <Icon type="presentation_chart_bar" {...props} />,
    },
  ];
        ...
        <div className="flex flex-col w-0 flex-1 overflow-hidden">
          <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
            ...
            >
              ...
              <Icon type="menu_alt2" className="h-6 w-6" aria-hidden="true" />
            </button>
